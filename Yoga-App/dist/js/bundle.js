...
function modalWindow() {
  ...
  for (var i = 0; i < btnDescription.length; i++) {
...
function slider() {
  ...
  function showSlides(number) {
    ...
    }); // ниже то же самое, но по-другому:
...
function timer() {
  ...
  function getTimeRemaining(endtime) {
    var remainedTime = Date.parse(endtime) - Date.parse(new Date()),
        seconds = Math.floor(remainedTime / 1000 % 60),
        minutes = Math.floor(remainedTime / 1000 / 60 % 60),
        hours = Math.floor(remainedTime / 1000 / 60 / 60); //hours = Math.floor((remainedTime/1000/60/60) % 24), -если у нас ещё есть дни, часы отображаются так
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var calculator = __webpack_require__(/*! ./parts/calculator */ "./src/js/parts/calculator.js"),
