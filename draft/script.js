...
let yury = new User('Yury', 24);

console.log(yury.name);
console.log(yury.age);
console.log(yury.getAge());
...
*/
// МОДУЛИ
// способ 1: анонимная самовызывающаяся функция
/*
let number = 1;
...
console.log(number); */
// Способ 2: использование объектного интерфейса
/*
let user = (function(){
    let privat = function(){
